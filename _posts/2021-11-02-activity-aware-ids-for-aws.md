...
At this point, you can add a statement to the policy for the role thus allowing it access to “CreateLogGroup” and give a fairly restrictive resource description.
