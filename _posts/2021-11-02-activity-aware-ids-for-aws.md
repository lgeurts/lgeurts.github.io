...
You can also configure Activity Aware IDS to notify you of AWS API actions, even when these actions are permitted, but this is more complex and something I simply did not have time for (so that task is up to you).
