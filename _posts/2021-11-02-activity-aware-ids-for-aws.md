...
A cornerstone of security in the AWS Cloud is the Shared Responsibility Model. At a higher level, this is a de-lineation between what AWS takes responsibility for to secure, and what you as an AWS Customer are responsible for securing.
