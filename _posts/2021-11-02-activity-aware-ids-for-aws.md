...
From the AWS side, they take responsibility for securing the building blocks used to compose your systems. These typically include **Compute** (EC2) hosts, **Storage** (S3) infrastructure, Databases (RDS), Networking infrastructure, and so on. That’s not to say you could throw all of your customers credit card data into an S3 bucket and think your security responsibility is according AWS policies.
<br>You still have to lock that bucket!
