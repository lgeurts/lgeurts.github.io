...
This problem is related to **thermal throttling** on Linux, which is set much below Windows values. It will cause the laptop to run slower than it should under heavy stress.
