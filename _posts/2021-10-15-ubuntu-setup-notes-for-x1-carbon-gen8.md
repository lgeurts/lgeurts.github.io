...
This problem is related to thermal throttling on Linux, which is set much below Windows values. This will cause a laptop to run much slower than it could under heavy stress.
