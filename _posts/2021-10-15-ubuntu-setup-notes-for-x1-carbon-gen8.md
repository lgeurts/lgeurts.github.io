...
The Windows option is a **newer software-based** "modern standby" which works on Linux (despite the name). One **benefit** to the **Windows** sleep state is a faster wake up time, and one **possible drawback** is increased power usage. 
