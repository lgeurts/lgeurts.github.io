...
This problem is related to thermal throttling on Linux, which is set below Windows values. This will cause your laptop to run much slower than it should under heavy stress.
