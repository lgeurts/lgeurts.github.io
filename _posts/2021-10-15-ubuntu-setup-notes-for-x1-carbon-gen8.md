...
I use lower temperature levels to preserve battery life. To change defalt values, edit /etc/lenovo_fix.conf, and set the Trip_Temp_C for both battery and AC the way you want:
```
[BATTERY]
# Other options here...
PL2_Tdp_W: 40
