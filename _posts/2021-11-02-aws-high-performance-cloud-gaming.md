...
1. [AWS Account](https://aws.amazon.com/premiumsupport/knowledge-center/create-and-activate-aws-account/) - Some knowhow in AWS would be nice, but no worries, follow my steps in this post and you will be ok.
