...
**Note:** If you want to save on the last penny, find the [nearest region at the lowest price](https://openupthecloud.com/find-aws-region-closest/). Want the fastest connection possible? Use [AWS ping](https://github.com/ekalinin/awsping) on GitHub.
