...
**Note:** If you want to save on the last penny, and need to find the [nearest region at the lowest price](https://openupthecloud.com/find-aws-region-closest/), while also having the fastest connection possible, you can use tools like [AWS ping](https://github.com/ekalinin/awsping) on GitHub.
