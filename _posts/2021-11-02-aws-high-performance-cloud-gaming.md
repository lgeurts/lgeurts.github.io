...
3.     A stabile internet connection, at least 30/40mbps FTTH (for low latency). The most difficult part is streaming latency. All steps such as running the game, encoding/decoding the game video and converting the player input are done in real time.
