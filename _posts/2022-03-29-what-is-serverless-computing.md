...
Speaking about cost, in contrast with VMs and/or containers, serverless services don't run continuously. A serverless setup will only start when it's invoked and will afterwards release all computing capacity. This is the reason why a serverless architecture is the most cost-effective way since you won’t have to pay for idle time.
