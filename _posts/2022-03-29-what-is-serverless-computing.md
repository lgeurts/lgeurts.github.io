...
This entire process of deploying servers, or any other devices, could take days to complete, and entails a high administrative overhead combined with exorbitant costs to the organization. Using the server-based model requires you to properly estimate and allocate capacity since you can't dynamically add or remove CPUs, disks etc. It’s basically inconvenient, labor-intensive, and downright very expensive to manage your own servers.
