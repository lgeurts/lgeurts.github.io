...
This is where serverless kicks in. Serverless is in essence a combo of a VM and a container. It is powered by a microVM with its own kernel, and just like containers it deploys faster than a virtual machine while st the same time it can be used to run your applications.
