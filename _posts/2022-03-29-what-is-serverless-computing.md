...
This is where serverless kicks in. Serverless is in essence a combo of a VM and container. It is powered by a microVM which has its own kernel. Just like a container, it deploys faster than a regular virtual machine and it can be used to run your applications.
