...
This entire process of deploying servers, or any other devices, could take days to complete, requires you to properly estimate and allocate capacity since you can't dynamically add or remove CPUs, disks etc. It’s basically inconvenient, labor-intensive, and entails exorbitant costs to the organization.
