...
This is where serverless comes in. Serverless is in essence a combo of VM and container. It is powered by a microVM which has its own kernel. Just like a container, it deploys faster than a Virtual Machine and it can be used to run your applications.
