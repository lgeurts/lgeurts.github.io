...
If this is a new device that you’ve never stored personal data on, I recommend that you first disable BitLocker Device Encryption temporarily before making changes to the drive partitions. Windows is quite decent at self-repairing any accidental damage or problems that can occur when manipulating partitions on a native NTFS drive, this in contrary to a BitLocker encrypted drive.
