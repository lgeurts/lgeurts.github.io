...
Be sure you have several copies of the most recent recovery key, or you may loose access to all your encrypted data! I'd recommend creating a script that automatically backups your key to a secure place on the cloud.
A good example is [this code](https://blog.ahasayen.com/how-to-backup-bitlocker-keys/).
