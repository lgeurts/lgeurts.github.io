...
To install a second operating system you'll need space on your system drive. You could also use a second drive, but this is probably not the option for laptop users and small-form-factor devices.
