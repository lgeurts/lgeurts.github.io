...
Linux (or another secondary operating system) installation is only covered in brief as we will focus on preserving the Windows pre-boot UEFI environment in such a setup.
