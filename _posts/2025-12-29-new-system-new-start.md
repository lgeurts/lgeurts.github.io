...
Anyways, we also decided to do a bit self-hosting and move all our laptops to something different. No more Ubuntu or Fedora but suckless DWM on Arch (with the performance kernel).
