...
- The same thing happened with software. Vim became nVim which in turn became Lazy-Vim (maybe later nvi). Alacritty became xterm, then st. Firefox became qutebrowser.
