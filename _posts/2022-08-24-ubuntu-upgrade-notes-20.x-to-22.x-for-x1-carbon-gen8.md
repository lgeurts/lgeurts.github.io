...
General recommendation from Ubuntu is making a backup and re-installing your system should you run a non-secure EOL release. Their advice is sound and often proves to be the fastest way. So, if you still decide to give this a try, **don't start yelling at me when your system goes bonkers**. Told you so.
