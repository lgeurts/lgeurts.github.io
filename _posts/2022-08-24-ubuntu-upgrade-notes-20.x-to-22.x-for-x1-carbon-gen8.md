...
General recommendation from Canonical is making backups and re-installing your system should you run a non-secure EOL release. Their advice is sound and often proves to be the safest way. So, if you still decide to give my post a try, don't dare yelling at me when your system goes bonkers. I told you so.
