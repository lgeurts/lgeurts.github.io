...
Docs differ significantly when compared to source code. In theory, it might look facinating to go down the “docs-as-code” approach. In practice it can get quite complex, especially when you are just creating software documentation in a few GitHub repos, or writing technical posts. If that's the case I suggest skipping or you should like self-punishment.
