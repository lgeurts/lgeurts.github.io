...
If your PC has at least 16 Gb RAM you can also achieve a little more performance by lowering the aggresive pressure on the inode cache. A small warning, clearing system memory less frequently will impact new processes trying to load (mem in use).
