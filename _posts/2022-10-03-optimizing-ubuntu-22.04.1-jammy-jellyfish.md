...
Disabling this function is really easy. Type about:config in de addressbar and press Enter. Click on agree and find sessionstore. Double-click the browser.sessionstore.interval and change 15000 (15 seconds) to 15000000. Press OK, restart Firefox.
