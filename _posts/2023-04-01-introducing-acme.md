...
Since I was talking about Vim, the Acme Text Editor written by [Rob Pike](https://github.com/robpike) for [Plan 9](https://p9f.org/) in the early 1990s is another favorite. Nothing but yellowish windows and blue bars with a focus on the job to be done.
