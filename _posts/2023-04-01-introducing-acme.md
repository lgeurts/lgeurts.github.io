...
Acme is a program that combines aspects of window systems, shells, and editors. It is designed to support software development but is not a programming toolkit; instead it is self-contained, more like a shell than a library, that joins users and applications. 
