...
It's difficult to explain something without seeing it though, so I added a screencast from [Russ Cox](https://www.youtube.com/@rscgolang) showing a brief programming session. 
