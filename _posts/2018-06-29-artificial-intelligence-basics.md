...
On the other hand, high variance problems are indicated by large gaps between training and validation error curves as training set sizes increase. You would see a low training error. In this case curves are converging and adding more training data would help.
