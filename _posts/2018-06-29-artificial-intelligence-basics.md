...
The number of positives and negatives generated by a model are crucial in evaluating its effectiveness. For that purpose we use this ***confusion matrix*** e.g. our basis for calculating performance metrics for the classifier.
