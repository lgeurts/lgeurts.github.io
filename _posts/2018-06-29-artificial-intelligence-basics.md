...
If our training and validation error curves flatten out at a high error as set sizes increases, means you have a high bias problem. Curves flattening out hints that getting more training data will not (by itself) help much.
