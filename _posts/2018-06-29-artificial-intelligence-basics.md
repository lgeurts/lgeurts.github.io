...
Cases where the model predicts a 1 for a test observation that actually has a value, a label value of 1, are considered true positives and cases where the model predicts 0, and the actual label is 0, are true negatives.
