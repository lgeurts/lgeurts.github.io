...
To generate a learning curve, you deliberately shrink the size of the training set and see how training and validation errors will change as you increase the size. This way, you can see how your model improves (or doesn't) with more training data.
