...
A treshold determines how predicted values are classified. In the case of the diabetes model, it will be better to have more false positives, thus reducing the amount of false negatives. This way more people with a risk of diabetes get identified.  
