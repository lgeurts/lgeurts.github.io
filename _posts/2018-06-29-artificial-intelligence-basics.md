...
If our training and validation error curves flatten out at a high error as set sizes increase, then there is a good chance you have a high bias problem. More training data will not (by itself) help much.
