...
The treshold determines how predicted values are classified. For the diabetes model, having more false positives, thus reducing the amount of false negatives, will be better as more people with a risk of diabetes get identified.  
