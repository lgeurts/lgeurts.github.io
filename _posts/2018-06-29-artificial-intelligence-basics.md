...
If our training and validation error curves flatten out at a high error as set sizes increases, there is a good chance you have a high bias problem. More training data will not (by itself) help much.
