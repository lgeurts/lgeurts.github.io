...
The actual number of positives and negatives that are generated by your model, is crucial in evaluating its effectiveness. This is often shown in a ***confusion matrix***, which provides the basis for calculating performance metrics for the classifier.
