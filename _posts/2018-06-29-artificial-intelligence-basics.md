...
The actual number of positives and negatives that are generated by your model, is crucial in evaluating its effectiveness. These are often shown in a so called ***confusion matrix***, which provides the basis for calculating performance metrics for the classifier.
