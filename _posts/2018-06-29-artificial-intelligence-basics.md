...
A treshold determines how predicted values are classified. Looking at our diabetes model, it will be better to have more false positives, thus reducing the amount of false negatives. This way more people with a risk of diabetes get identified.  
