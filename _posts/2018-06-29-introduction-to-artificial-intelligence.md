...
Let's take one male. We want to model calories burned while exercising. First we get some pre-liminary data, then put him on a fitness monitor and start capturing more data using known features like age, weight, heart rate, duration. In this case we have a known label value of 231 calories. So we need our algorithm to learn the function that operates of all of his exercise features to give us a net result of 231.
