...
Let's start with a data set that contains historical records. Every record includes some numerical values (X) that quantify a characteristic of the item we're working with. 
