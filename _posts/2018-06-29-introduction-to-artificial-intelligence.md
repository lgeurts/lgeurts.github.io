...
We'll train the model by finding similarities between observations. Once we have trained the model, any new observations are added to a group (officially a ***cluster***) of observations with akin characteristics.
