...
There are two main kinds of machine learning, ***supervised*** and ***unsupervised***. In supervised learning scenarios, we start with the observations that include known values for the variable we want to predict. We call these labels.
