...
We'll train the model by finding similarities between observations. Once we have trained the model, new observations are added to a group (cluster) of observations with akin characteristics.
