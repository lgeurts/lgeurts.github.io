...
We start with a data set that contains historical records. Records include numerical values (X) that quantify a characteristic of the item we're working with. 
