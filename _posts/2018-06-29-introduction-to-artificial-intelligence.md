...
Let's start with a data set that contains historical records. Every record includes numerical values (X) that quantify characteristics of the item we are working with. 
