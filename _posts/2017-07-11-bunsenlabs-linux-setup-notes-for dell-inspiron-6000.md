...
***Note:*** [Memo](/assets/vim-plugin-settings.txt) for activating Command-T, NerdTree and Git Gutter plugins in .vimrc.      Lazy? Download my latest [config](https://github.com/lgeurts/BunsenLabs-Setup/tree/master/.vim/).
