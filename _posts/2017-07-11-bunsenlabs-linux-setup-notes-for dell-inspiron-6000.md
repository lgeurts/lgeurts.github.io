...
***Note:*** My [memo](/assets/vim-plugin-settings.txt) for activating Command-T, NerdTree and Git Gutter. Lazy? Download my latest [vimrc](https://github.com/lgeurts/BunsenLabs-Setup/tree/master/.vim/).
