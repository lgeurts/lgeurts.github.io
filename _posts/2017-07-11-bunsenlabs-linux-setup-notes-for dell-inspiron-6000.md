...
***Note:*** The plugins I'm presently using. An updated .xml file with strings for User-Agent Switcher is available [here](http://techpatterns.com/forums/about304.html).
