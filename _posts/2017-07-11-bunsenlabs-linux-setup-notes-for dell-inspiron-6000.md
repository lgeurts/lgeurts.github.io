...
***Note:*** Top 5 add-ons: [[HTTPS Everywhere]](https://www.eff.org/https-everywhere) [[Ghostery]](https://addons.mozilla.org/en-US/firefox/addon/ghostery/) [[DuckDuckGo]](https://addons.mozilla.org/en-US/firefox/addon/duckduckgo-for-firefox/) [[Stylish]](https://addons.mozilla.org/en-US/firefox/addon/stylish/) [[User-Agent Switcher]](https://addons.mozilla.org/en-US/firefox/addon/user-agent-switcher-firefox/) (an updated .xml file with agents is available [here](http://techpatterns.com/forums/about304.html)).
...
***Update:*** The BunsenLabs moderators have built packages which give your Openbox rounded corners. Still experimental but I installed the i386 .deb file without any issues. A how-to can be found [here](https://forums.bunsenlabs.org/viewtopic.php?id=3173&p=3)
