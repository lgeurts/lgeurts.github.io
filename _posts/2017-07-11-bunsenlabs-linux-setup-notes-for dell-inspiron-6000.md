...
***Note:*** The plugins I'm presently using. A .xml file with updated strings for User-Agent Switcher is available [here](http://techpatterns.com/forums/about304.html).
