...
**Note:** Now that your vim starts to look better, let’s improve how it functions.  You can either visit this [repo](https://github.com/amix/vimrc) for further customization (recommended because learning on the fly), or simply copy my dotfile (see end of chapter 6).
