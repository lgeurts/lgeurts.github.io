...
***Update:*** I switched from Sublime to [Atom](https://atom.io/). GitHub does not offer an i386 build but luckily [Andras Retzler](http://ha5kfu.sch.bme.hu/node/189) took the time to create one. Mind you it's an old version, maybe [build your own](https://github.com/atom/atom/blob/master/docs/build-instructions/linux.md)?
