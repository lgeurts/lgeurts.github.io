...
BunsenLabs contains a bunch of apps you can install with a simple click via the Openbox menu. Other apps will be pulled from the repositories or 3rd party sources. In that case, the instructions will show an apt-get install command. Let's run thru the list.
