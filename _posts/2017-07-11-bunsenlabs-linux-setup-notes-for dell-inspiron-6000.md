---
layout: post
title: BunsenLabs Linux Setup Notes for Dell Inspiron 6000
comments: true
tags: [ linux, tutorial ]
---
...
BunsenLabs does not use a traditional desktop like a KDE, GNOME or even Xfce. Instead it's an optimized mix of components from various open source projects including most notably the lightweight Openbox window manager, the tint2 panel, the Conky system monitor, and Thunar file manager.
...
Here is a rundown of how I configured BunsenLabs on a Dell Insprion 6000 (JARREAU) to best serve my needs:
